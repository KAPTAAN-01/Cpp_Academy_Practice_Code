...
public:
 ...
 void managment(){
    ...
    cout<<"ENTER 1 FOR ADDMISSION FORM"<<endl;
    cout<<"ENTER 2 FOR FEES"<<endl;
    cout<<"ENTER 3 FOR ATTENDANCE"<<endl;
    cout<<"ENTER 4 FOR TEST MANAGMENT"<<endl;
    cout<<"ENTER 5 FOR EMPLOYEES MANAGMENT"<<endl;
     cin>>v;
     if(v==1){
         admissionform form;
...
int main(){
    ...
    while (runAgain == 'Y' || runAgain == 'y') {
        managment();
        cout << "IF YOU WANT TO RUN THIS PROGRAM AGAIN ENTER YES(Y/y)" << endl;
        cin >> runAgain;
    }
